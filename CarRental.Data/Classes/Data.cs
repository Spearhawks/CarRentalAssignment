...
public class Data : IData
{
    ...
    Customer cust3 = new(1, "Dwayne", "Jonson");
    ...
    private void SeedData()
    {
        ...
        _persons.Add(new Customer { CustID = 2, FirstName = "The", LastName = "Rock" });
        _persons.Add(new Customer { CustID = 3, FirstName = "Dwayne", LastName = "Jonson" });
        _persons.Add(new Customer { CustID = 4, FirstName = "Bobba", LastName = "Fett" });
        ...
        _vehicles.Add(new Car { RegistrationNo = "ABC123", Make = "Volvo", Odometer = 3233, CostPerKm = 120, CostPerDay = 300, VehicleType = VehicleType.Van, RentedStatus = RentedStatus.Available });
        _bookings.Add(new Booking { RegistrationNo = "ABC123", Customer = cust1, KmRented = 3233, KmReturned = 3333, Rented = rentedDate, Returned = new(), Cost = 0, Status = BookingStatus.Open });
        ...
        _bookings.Add(new Booking { RegistrationNo = "ABC123", Customer = cust2, KmRented = 3233, KmReturned = 3333, Rented = rentedDate, Returned = new(), Cost = 0, Status = BookingStatus.Open });
    }
